...
const reasons = [
  { 
    ...
    desc: "We build secure, scalable websites and digital products designed to grow with your business.",
    rotate: -12,
    x: -180,
    y: 40,
    zIndex: 1
  ...
  { 
    ...
    desc: "We optimize images, code rendering, and page architecture to create blazing fast experiences.",
    rotate: -4,
    x: -60,
    y: 10,
    zIndex: 2
  ...
  { 
    ...
    desc: "Every website is planned around your business goals, target audience, and conversion journey.",
    rotate: 4,
    x: 60,
    y: 10,
    zIndex: 3
