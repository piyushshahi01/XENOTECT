...
const reasons = [
  { 
    ...
    desc: "Every line of code and pixel is meticulously crafted to ensure the highest standards.",
    rotate: -12,
    x: -180,
    y: 40,
    zIndex: 1
  ...
  { 
    ...
    desc: "Agile methodologies guarantee rapid turnaround times without sacrificing stability.",
    rotate: -4,
    x: -60,
    y: 10,
    zIndex: 2
  ...
  { 
    ...
    desc: "Every project is aligned with your business goals to drive immediate revenue.",
    rotate: 4,
    x: 60,
    y: 10,
    zIndex: 3
  ...
  { 
    ...
    desc: "Creating memorable, high-converting experiences that users love and competitors envy.",
    rotate: 12,
    x: 180,
    y: 40,
    zIndex: 4
